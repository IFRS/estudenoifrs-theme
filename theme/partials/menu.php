...
<nav class="navbar navbar-expand-lg navbar-dark">
    <button class="navbar-toggler bg-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#<?php echo $offcanvas_id; ?>" aria-controls="<?php echo $offcanvas_id; ?>">
        ...
        <span class="align-middle fs-6 visually-hidden">Menu</span>
    </button>
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" aria-labelledby="<?php echo $offcanvas_label_id; ?>" id="<?php echo $offcanvas_id; ?>">
        <div class="offcanvas-header">
            <h2 class="offcanvas-title" id="<?php echo $offcanvas_label_id; ?>"><?php echo bloginfo('name'); ?> - Menu</h2>
