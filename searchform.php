<form role="search" method="get" class="searchform row row-cols-sm-auto g-3 align-items-center" action="<?php echo esc_url(home_url('/')); ?>">
    ...
    <div class="col-12">
        ...
        <div class="input-group">
            <input type="search" value="<?php echo get_search_query(); ?>" name="s" id="<?php echo $idBusca; ?>" class="form-control form-control-sm border searchform__input" placeholder="Termo da Busca" required>
