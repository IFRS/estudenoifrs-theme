<?php if (is_active_sidebar('area-carousel')) : ?>
    ...
    <div id="<?php echo $carousel_id; ?>" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <a class="carousel-control-prev" href="#<?php echo $carousel_id; ?>" role="button" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Anterior</span>
        </a>
        <a class="carousel-control-next" href="#<?php echo $carousel_id; ?>" role="button" data-bs-slide="next">
