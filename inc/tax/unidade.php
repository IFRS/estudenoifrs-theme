<?php
if ( ! function_exists( 'ingresso_unidade_taxonomy' ) ) {
    function ingresso_unidade_taxonomy() {
        $labels = array(
            ...
            'menu_name'                  => __( 'Unidade', 'ifrs-ingresso-theme' ),
        ...
        register_taxonomy( 'unidade', array( 'oportunidade' ), $args );
    }

    add_action( 'init', 'ingresso_unidade_taxonomy', 0 );
}
